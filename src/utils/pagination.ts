 ...
 * - buildPageTokens: 좌/우 경계(boundary)와 형제(sibling) 개수를 고려한 안전한 토큰 시퀀스
...
export function buildPageTokens(
  ...
  if (currentLen < middleDesired) {
    const deficit = middleDesired - currentLen
